...
import { getPrimaryAction } from "@/lib/dashboard/module-page-utils";
    ...
    <div className="grid min-w-0 gap-5">
      <section className="rounded-md border border-border border-l-4 border-l-primary bg-card p-5">
        <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
          ...
          <div className="rounded-md border border-brand-mist-strong bg-brand-soft px-4 py-3">
            <p className="text-xs font-semibold text-muted-foreground">Primary action</p>
      ...
      <section className="grid gap-5 xl:grid-cols-[1fr_360px]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Available information and tools for this page.</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Common actions available to administrators.</CardDescription>
          </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>The usual steps for completing this work.</CardDescription>
        </CardHeader>
