...
const engagementRequestSchema = new Schema(
  {
    ...
    adminViewedAt: { type: Date, default: null, index: true },
    adminApprovedAt: { type: Date, default: null, index: true },
    kycUnlockedAt: { type: Date, default: null, index: true },
    kycApprovedAt: { type: Date, default: null, index: true },
