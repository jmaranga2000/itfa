...
const workflowCompletionSchema = new Schema(
  {
    ...
    closureSummary: {
      type: {
        ...
        totalDeliverablesReleased: { type: Number, default: 0 },
        totalInternalReviews: { type: Number, default: 0 },
...
const workflowInstanceSchema = new Schema(
  {
    ...
    previousEngagementId: { type: Schema.Types.ObjectId, default: null, index: true },
    previousEngagementReference: { type: String, default: "", index: true },
