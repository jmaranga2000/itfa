...
const engagementLetterSignerSchema = new Schema(
  {
    ...
    method: { type: String, enum: ["typed", "uploaded"], default: "typed" },
...
const engagementLetterSchema = new Schema(
  {
    ...
    signedCopyDocumentId: { type: Schema.Types.ObjectId, default: null },
    signedCopyStorageKey: { type: String, default: null },
