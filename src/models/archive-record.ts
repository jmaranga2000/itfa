...
const archiveRecordSchema = new Schema(
  {
    ...
    archivePackageStorageKey: { type: String, default: "" },
    archivePackageFileName: { type: String, default: "" },
    archivePackageSize: { type: Number, default: 0 },
    archivePackageCreatedAt: { type: Date, default: null },
